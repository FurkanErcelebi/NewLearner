    ...
    public static void main(String[] args) {
        try {
            ...
            while(true){
                ...
                System.out.println("Give pdf file path that will conveted to image file");
                sourceDir = scanner.nextLine();
                //System.out.println(sourceDir + "\n");
                int lastInd = sourceDir.lastIndexOf(File.separator);
                destinationDir = sourceDir.substring(0, lastInd + 1);
                
                // converted images from pdf document
                // are saved here
